...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">app-web-rift documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/Catalogo.html" data-type="entity-link" >Catalogo</a>
                            </li>
                            <li class="link">
                                <a href="components/DetalleCarta.html" data-type="entity-link" >DetalleCarta</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/Carta.html" data-type="entity-link" >Carta</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/Carta-1.html" data-type="entity-link" >Carta</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/Carta-2.html" data-type="entity-link" >Carta</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/Carta-3.html" data-type="entity-link" >Carta</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="interfaces/ItemCarrito-1.html" data-type="entity-link" >ItemCarrito</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ItemCarrito-2.html" data-type="entity-link" >ItemCarrito</a>
                            </li>
                            <li class="link">
